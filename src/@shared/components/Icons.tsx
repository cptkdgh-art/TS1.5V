 ...
 * @file Icons.tsx
 * ============================================================
 * @description SVG 아이콘 컴포넌트 라이브러리
 * ============================================================
 */
...
export const WriterAgentIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.7} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="m14 8 3 3M4 20l1-5L15 5a2.12 2.12 0 0 1 3 3L8 18l-4 2ZM4 20h9M19 2l.8 2.2L22 5l-2.2.8L19 8l-.8-2.2L16 5l2.2-.8L19 2Z" />
  </svg>
);
...
export const UserGroupIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-2.438c.155-.18-.221-.398-.421-.24a1.125 1.125 0 01-1.125-1.125V13.5A3.375 3.375 0 0016.5 10.125h-9A3.375 3.375 0 004.125 13.5v3.75a1.125 1.125 0 01-1.125 1.125c-.2.158-.576-.06-.421-.24A9.337 9.337 0 006.375 19.5a9.38 9.38 0 002.625-.372M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
  </svg>
);
...
export const ChatBubbleThoughtIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 20.25c4.97 0 9-3.694 9-8.25s-4.03-8.25-9-8.25S3 7.444 3 12c0 2.104.859 4.023 2.273 5.48.432.447.74 1.04.586 1.641a4.483 4.483 0 01-.923 1.785A5.969 5.969 0 006 21c1.282 0 2.47-.402 3.445-1.087.81.22 1.668.337 2.555.337zM7.5 12.75h.008v.008H7.5v-.008zm3.75 0h.008v.008h-.008v-.008zm3.75 0h.008v.008h-.008v-.008z" />
  </svg>
);
...
export const Bars2Icon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const PinIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 4.5l4.5 4.5-3 1.5-3.75 3.75.75 3.75-1.5 1.5-3.75-4.5L3 11.25l1.5-1.5 3.75.75L12 6.75 13.5 3 15 4.5zM9.75 14.25L4.5 19.5" />
  </svg>
);

export const PaperAirplaneIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6 12L3.269 3.875A59.77 59.77 0 0121.485 12 59.768 59.768 0 013.27 20.125L6 12zm0 0h7.5" />
  </svg>
);
...
export const ChatBubbleLeftEllipsisIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 01-2.555-.337A5.972 5.972 0 015.41 21H5.25A2.25 2.25 0 013 18.75V12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z" />
  </svg>
);

export const DiceIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M21.125 10.375c.366.422.625.93.625 1.5v3.75c0 .57-.259 1.078-.625 1.5m-18.25 0c-.366-.422-.625-.93-.625-1.5v-3.75c0-.57.259-1.078.625-1.5M12 21.75a9.75 9.75 0 01-9.375-7.375m18.75 0A9.75 9.75 0 0012 21.75m-9.375-7.375A9.75 9.75 0 0112 2.25c4.625 0 8.57 3.34 9.375 7.75M9 13.5a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm3.75-3.75a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm3.75 3.75a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
  </svg>
);
...
export const LightBulbIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.311a15.045 15.045 0 01-7.5 0C4.505 20.995 2.25 18.288 2.25 15c0-1.605.32-3.124.89-4.514m13.72 0c.57.39.91.99.91 1.634v2.162M12 18.75v-5.25m0 0a6.002 6.002 0 00-4.473 2.182" />
  </svg>
);
...
export const BrainIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.998 15.998 0 013.388-1.622m0 0a2.25 2.25 0 003.767-1.973 4.5 4.5 0 00-8.4-2.245 4.5 4.5 0 00-1.087 2.245 2.25 2.25 0 003.767 1.973zM12 21a2.25 2.25 0 002.25-2.25M12 3c-1.655 0-3.16.69-4.262 1.83a2.25 2.25 0 00-.738 1.516c0 .399.078.78.22 1.128a2.25 2.25 0 003.767 1.973 4.5 4.5 0 008.4 2.245 4.5 4.5 0 00-1.087-2.245 2.25 2.25 0 00-3.767-1.973A4.5 4.5 0 0012 3z" />
  </svg>
);
...
export const SwatchIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 12.75l6 6" />
  </svg>
);
...
export const BarsArrowUpIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 4.5h14.25M3 9h9.75M3 13.5h5.25m5.25-.75L17.25 9m0 0L21 12.75M17.25 9v12" />
  </svg>
);

export const BarsArrowDownIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
